...
from utils.control_evaluators import SegmentationControlEvaluator
...
class EvalData(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # pil_seg_image = center_crop_and_resize(pil_seg_image, (self.image_size, self.image_size))
