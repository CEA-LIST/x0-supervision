...
class LatentDiffusionEps2X0(LatentDiffusion):
    ...
    def p_losses(self, x_start, cond, t, noise=None, **kwargs):
        ...
        if self.parameterization == "eps":
            ...
            x_start_est = (x_noisy - sigma_t * model_output) / alpha_t
            pred = x_start_est
        else:
            raise NotImplementedError()
...
class LatentDiffusionEps2V(LatentDiffusion):
    ...
    def p_losses(self, x_start, cond, t, noise=None, **kwargs):
        ...
        if self.parameterization == "eps":
            alpha_t = extract_into_tensor(self.sqrt_alphas_cumprod, t, x_start.shape)
            sigma_t = extract_into_tensor(self.sqrt_one_minus_alphas_cumprod, t, x_start.shape)
            v_est = alpha_t * model_output - sigma_t * x_start
