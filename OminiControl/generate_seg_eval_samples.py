...
from omini.pipeline.control_evaluators import SegmentationControlEvaluator
...
parser.add_argument("--num_eval_images", type=int, default=None)
...
class EvalData(Dataset):
    def __init__(self, metadata_path, condition_size, target_size, position_scale=1.0):
        super().__init__()
...
if __name__ == "__main__":
    ...
    control_evaluator = SegmentationControlEvaluator()
    IS = InceptionScore()
    ...
    for sample in tqdm(dataset):
        ...
        batch_results = control_evaluator([pil_generated_image], seg[None,...])
