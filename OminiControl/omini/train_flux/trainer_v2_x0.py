...
class OminiModel(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Convert velocity prediction to x0-prediction (noise prediction)
        ...
        d_sigma_t = -1
        small_shift = 1e-17
        x0_est = (alpha_t / (d_sigma_t*alpha_t - d_alpha_t*sigma_t + small_shift)) * (pred - d_alpha_t * x_t / (alpha_t + small_shift))

        # Compute loss
        step_loss = torch.nn.functional.mse_loss(x0_est, x_0, reduction="mean")
